...
//  type ActionTypes = AddPostAT | UpdateNewTextPostAT | UpdateNewTextMessageAT | SendMessageAT;
...
//     this._state.profilePage = profileReducer(this._state.profilePage, {type: 'ADD-POST'});
//     this._state.messagesPage = dialogsReducer(this._state.messagesPage, {type: "UPDATE-NEW-TEXT-MESSAGE", text: ''});
